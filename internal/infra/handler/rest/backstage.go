...
func (obj *BackstageHandlerHttp) TriggerSyncProvider(c *gin.Context) {
	...
	response, err := obj.Service.TriggerSyncProvider(context.Background(), trigger)
	if err != nil {
...
func (obj *BackstageHandlerHttp) GetAllKinds(c *gin.Context) {
	...
	result, err := obj.Service.GetAllKinds(context.Background(), entity.FilterKind{
...
func (obj *BackstageHandlerHttp) GetKind(c *gin.Context) {
	...
	result, err := obj.Service.GetAllKinds(context.Background(), filter)
